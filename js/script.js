...
function displayCourses(filteredCourses) {
  ...
  resultCount.innerText = `Showing ${filteredCourses.length} course${filteredCourses.length === 1 ? "" : "s"}`;
  ...
  filteredCourses.forEach((course) => {
    ...
    let courseCard = `
      <div class="course-card" ${hasRevealedOnce ? "" : "data-reveal"}>
        <div class="img-wrap">
        ...
        <div class="details">
          ...
          <a href="${course.link}" target="_blank" rel="noopener noreferrer"><i class="fas fa-arrow-up-right-from-square"></i> View Course</a>
          <a href="mailto:${REPORT_EMAIL}?subject=${reportSubject}&body=${reportBody}" class="report-link"><i class="fas fa-flag"></i> Report broken link</a>
        </div>
      </div>
    `;
